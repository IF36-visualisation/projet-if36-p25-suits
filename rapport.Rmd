...
---
title: "Population et Diversité des Classes d'Entreprises : Quelle Relation ?"
---
...
Existe-t-il une relation entre la population totale d'une région et la diversité des tailles d'entreprises qu'elle héberge ?

Pour ce faire, nous analyserons :

- la population totale des régions françaises,
- la diversité des classes d'entreprises (nombre de tailles d'établissements présentes).
...
- Calculer pour chaque commune le nombre de classes d’entreprises existantes,
- Fusionner ces données avec la population par commune,
- Résumer les résultats au niveau régional.
...
**Les régions les plus peuplées présentent-elles également une diversité plus importante en types d'entreprises ?**

Notre hypothèse est qu'une population plus élevée pourrait favoriser un écosystème économique plus varié.
...
Les données utilisées dans cette analyse proviennent de la source suivante :  
**[Lien vers le dataset sur Kaggle](https://www.kaggle.com/datasets/etiennelq/french-employment-by-town)**
